...
import src.metrics
import src.reducers
from src.utils.py_utils import get_registry


DATASET_REGISTRY = get_registry(src.datasets)
METRIC_REGISTRY = get_registry(src.metrics, exclude_substr=[])
REDUCER_REGISTRY = get_registry(src.reducers)
